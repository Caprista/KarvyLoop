...
def test_minimax_cn_registered_separately():
    ...
    借 hermes plugins/model-providers/minimax/__init__.py:62-80 的"2 个 profile 同协议不同 baseUrl"模式;
    clean-room 重写(CLAUDE.md REFERENCES.md:41)。
...
def test_minimax_cn_aliases():
    """AC15b: minimax-cn 的 aliases 解析(借 hermes minimax-china/minimax_cn 模式)。"""
    # 主名直查
