...
def run_intent_via_loop(
    ...
    *,
    ...
    # 退出码:M1 v1 — 慢脑成功的 crystallized 算 0,快脑命中算 0;失败由 forge 自己处理
    # (forge_slow_brain_factory 同步化时 RunResult.terminal 不透出 —— 留 P1 修;
    # 当前最简化:crystallized=True 或 fast_brain_hit=True 视为 0,否则 0/1 取决于
    # 慢脑有 text 输出)
