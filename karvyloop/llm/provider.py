...
设计蓝本(clean-room 改写,CLAUDE.md REFERENCES.md:41 定性):
  - hermes-agent-main/ plugins/model-providers/<name>/__init__.py ProviderProfile dataclass
  - openclaw-main/ packages/llm-core/src/types.ts KnownApi 协议字符串 join key
