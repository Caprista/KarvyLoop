...
- 🤫 **它开始学着"什么时候别打扰你"。** 小卡对你决策的预测命中率不只是照镜子:按决策的种类,一旦它连续足够久、足够准(≥20 例、≥90%),就会**主动提议**由它把这一类安静处理。这份"静默"要你**显式授予**(绝不自作主张,高危动作一律排除,只要错一次立刻收回)—— 于是它慢慢挣到资格,在那些它已经学会你会怎么拍的事上,不再打断你。
